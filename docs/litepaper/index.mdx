...
<SEOHead
  ...
  description="EXPchain is a decentralized blockchain protocol designed for scalable, verifiable, and privacy-preserving AI applications, powered by Polyhedra innovations including Expander and zkBridge for high performance zkML."
...
<div className="expchain-diagram">
  <img
    ...
    width="100%"
    alt="Figure 1: EXPchain establishes foundations for the future of decentralized, privacy-conscious, and accountable AI systems."
  />
  Figure 1: EXPchain establishes foundations for the future of decentralized,
  privacy-conscious, and accountable AI systems.
</div>
